...
const request =
    [
        ...
        area: "South London",
        para: "is pretty ",
        photo_reference: "../assets/images/listings/tog.jpg",
        posted: new Date('2020-12-31'),
        web: "https://www.theofficegroup.com/uk/201-borough-high-street",
        cat_icon: 'building'
    },*/
        {
        ...
        /*{
            placeId: "ChIJfRPWH9UEdkgRvmCfqtgSKlM",
            fields: ["name", "formatted_address", "place_id", "geometry"],
            title: "Born Freelance",
            area: "South London",
            para: "is pretty ",
            photo_reference: "../assets/images/listings/headspace.jpg",
            posted: new Date('2020-12-31'),
            web: "https://www.bornfreelance.co.uk/",
            cat_icon: 'building'
        }*/
    ];